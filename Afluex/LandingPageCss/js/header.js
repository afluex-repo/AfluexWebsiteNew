document.write(`
      <meta charset="utf-8">
      <title>Afluex Multiservices LLP - Software Development Company</title>
      ...
      <!--website-favicon-->
      <link href="../LandingPageCss/images/favicon.png" rel="icon">
      <link href="../LandingpageCss/css/bootstrap.min.css" rel="stylesheet">
      <link href="../LandingpageCss/css/plugin.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css" integrity="sha512-xh6O/CkQoPOWDdYTDqeRdPCVd1SpvCA9XXcUnZS2FmJNp1coAFzvtCN9BmamE+4aHK8yyUHUSCcJHgXloTyT2A==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link href="../LandingpageCss/css/css2.css?family=Open+Sans:wght@400;600;700&family=Poppins:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    <!-- template-style-->
 ...
 top:-25% !important;
      ...
      <div class="onloadpage" id="page_loader">
         <div class="pre-content">
            <div class="logo-pre"><img src="../LandingPageCss/images/dark_logo.png" alt="Logo" class="img-fluid"></div>
         </div>
       </div>
      <!--End Preloader -->
      <!--Start Header -->
            ...
            <nav id="main-nav">
               <ul class ="first-nav">
                  <li>
                     ...
                     <li>
                        <a href="https://afluex.com/web/company-overview" target="blank">About Us</a>
                     </li>
                     <li>
                        <a href="https://afluex.com/web/website-development-company">Our Services</a>
                     </li>
                     <li>
                        <a href="https://afluex.com/web/real-estate-software-company" target="blank">Our Products</a>
                     </li>
                     <li>
    ...
    <div class ="niwaxofcanvas offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample">
      <div class ="offcanvas-body">
        ...
        <div class ="form-block sidebarform">
          ...
          <form id="form" data-bs-toggle="validator" class ="shake mt20">
            <div class ="row">
              <div class ="form-group col-sm-12">
                <input type="text" id="name" placeholder="Enter Your First Name" required="" data-error="Please fill Out">
